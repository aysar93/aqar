                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        "عقارات الأنبار هو تطبيق ومنصة رقمية متخصصة في عرض وتسويق العقارات داخل محافظة الأنبار، صُمم لتوفير تجربة سهلة وآمنة تجمع بين المالك، والمكاتب العقارية، والباحثين عن العقارات في مكان واحد.\n\n"
                      ...
                      SizedBox(height: 8),
                      Text(
                        "يعمل تطبيق عقارات الأنبار كمنصة إلكترونية لعرض الإعلانات العقارية وتسهيل التواصل بين المستخدمين. ولا يُعد التطبيق طرفاً في عمليات البيع أو الشراء أو الإيجار، ولا يتحمل أي مسؤولية عن الاتفاقات أو الالتزامات أو النزاعات التي قد تنشأ بين الأطراف.\n\n"
