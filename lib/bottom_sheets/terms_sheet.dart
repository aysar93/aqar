              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    _term(
                      "١. قبول الشروط",
                      "باستخدامك لتطبيق عقارات الأنبار فإنك تقر بقراءة هذه الشروط والأحكام وتوافق على الالتزام بها. وإذا كنت لا توافق على أي جزء منها، فيرجى عدم استخدام التطبيق أو خدماته",
                    ),
                    _term(
                      "٢. مسؤولية المستخدم",
                    ...
                    _term(
                      "٨. حدود المسؤولية",
                      "يعمل تطبيق عقارات الأنبار كمنصة إلكترونية لعرض الإعلانات العقارية والتواصل بين المستخدمين، ولا يكون طرفاً في عمليات البيع أو الشراء أو الإيجار، ولا يتحمل أي مسؤولية عن الاتفاقات أو النزاعات أو الخسائر التي قد تنشأ بين الأطراف",
                    ),
                    _term(
                      "٩. الملكية الفكرية",
