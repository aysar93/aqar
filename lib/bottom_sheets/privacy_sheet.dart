                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        "تلتزم منصة عقارات الأنبار بحماية خصوصية مستخدميها واحترام سرية بياناتهم الشخصية. توضح هذه السياسة نوع المعلومات التي يتم جمعها، وكيفية استخدامها وحمايتها، والخيارات المتاحة للمستخدم فيما يتعلق ببياناته عند استخدام التطبيق",
